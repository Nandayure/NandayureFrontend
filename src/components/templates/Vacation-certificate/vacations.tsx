...
import { useuseVacationsData } from '@/hooks';
...
const VacationCertificate: React.FC<VacationCertificateProps> = ({ id }) => {
  const { data, isLoading, error } = useuseVacationsData({ id });
            ...
            <Page size="A4" style={vacationsStyles.page}>
              <View style={vacationsStyles.container}>
                ...
                <View style={vacationsStyles.header}>
                  <Image
                    style={{ ...vacationsStyles.logo }}
                    src="/LogoMuni.png"
                  />
                  <View style={vacationsStyles.titleContainer}>
                    <Text style={vacationsStyles.title}>
                      MUNICIPALIDAD DE NANDAYURE
                    </Text>
                    <Text style={vacationsStyles.subtitle}>
                ...
                <View style={vacationsStyles.sectionFullWidth}>
                  <Text style={vacationsStyles.subtitle}>
                    {' '}
                    BOLETA SOLICITUD DE VACACIONES LEGALES
                  </Text>
                </View>
                ...
                <View style={vacationsStyles.sectioninfo}>
                  <View style={vacationsStyles.infoContainer}>
                    <View style={vacationsStyles.infoItem}>
                      <Text style={vacationsStyles.infoLabel}>
                        Nombre del solicitante:
                      </Text>
                      <Text style={vacationsStyles.infoValue}>
                ...
                <View style={vacationsStyles.alignmentContainer}>
                  ...
                  <View style={vacationsStyles.alignmentSection}>
                    <Text style={vacationsStyles.sectionTitle}>
                      Departamento:
                    </Text>
                    <Text style={vacationsStyles.value}>
                      {data.departamento}
                    </Text>
                  </View>
                  ...
                  {/* Periodos Vencidos */}
                  <View style={vacationsStyles.alignmentSection}>
                    <Text style={vacationsStyles.periodos}>
                      Periodos Vencidos
                    </Text>
                    ...
                    <View style={vacationsStyles.fieldRowperiodo}>
                      ...
                      <Text style={vacationsStyles.valueperiodo}>
                        {data.anios}
                      </Text>
                    </View>
                    <View style={vacationsStyles.fieldRowperiodo}>
                ...
                <View style={vacationsStyles.signatureAuthorizationContainer}>
                  ...
                  <View style={vacationsStyles.signatureItem}>
                    ...
                    <Text style={vacationsStyles.signature}>
                  ...
                  <View style={vacationsStyles.authorizationItem}>
                    ...
                    <View style={vacationsStyles.autorizacionRow}>
                      <Text style={vacationsStyles.autorizacion}>
                        2. Autorizado por Jefe Inmediato:
                        _______________________
                      </Text>
                    </View>
                    <View style={vacationsStyles.autorizacionRow}>
                      <Text style={vacationsStyles.autorizacion}>
                        3. Revisado por Encargado de Recursos Humanos:
                        _______________________
                      </Text>
                    </View>
                    <View style={vacationsStyles.autorizacionRow}>
                ...
                <View style={vacationsStyles.section}>
                  ...
                  <Text>
                    1.Todo aquel funcionario que requiera tramitar las
                    vacaciones legales debe realizar la solicitud con mínimo una
                    semana de anticipación, ya que deben ser revisadas y
                    posteriormente aprobadas. Por consiguiente las solicitudes
                    con menos de 3 días tramitadas serán analizadas para su
                    aprobación según el grado de urgencia
                  </Text>
                  <Text>
                    2.Antes de presentar la solicitud a recursos humanos, esta
                    debe de venir autorizada por el jefe y gestor del área. Las
                    aprobaciones las debe de coordinar el encargado de recursos
                    humano. Incluyendo la del alcalde
                  </Text>
                  <Text>
                    3. Si falta alguna de las firmas, la solicitud no tendrá
                    validez.
                  </Text>
                </View>
              </View>
