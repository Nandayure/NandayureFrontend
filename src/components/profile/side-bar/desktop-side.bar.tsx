...
interface DesktopSidebarProfileProps {
  navLinks: Record<string, NavLink>;
}

export function DesktopSidebarProfile({
  navLinks,
}: DesktopSidebarProfileProps) {
  ...
  return (
    <aside
      className={clsx(
        'flex flex-col h-screen transition-all duration-300 bg-white border-r border-gray-200',
